...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  var titles = pasteBoard.stringForType(NSPasteboardTypeString); //var titles = [pasteBoard stringForType:NSPasteboardTypeString];

  var lines = String(titles).split('\n');

  var documents = __webpack_require__(/*! sketch/dom */ "sketch/dom").Document.getDocuments(); //第一个打开的文件
